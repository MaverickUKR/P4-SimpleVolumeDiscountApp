...
//   discountLevels,
// }) => {
//   const [quantity, setQuantity] = useState(1); // Текущее количество
//   const [maxVolume, setMaxVolume] = useState(1); // Максимальный объем из уровней скидок
...
//       if (quantity >= discountLevels[i].volume) {
//         progress = ((i + 1) / discountLevels.length) * 100; // i+1 компенсирует смещение
//       } else {
//         break;
//       }
//     }
...
//       style={{
//         background:
//           "repeating-linear-gradient(45deg, #ffffff, #ffffff 10px, #f7f7f7 10px, #f7f7f7 20px)",
//         padding: "20px 80px",
//         borderRadius: "8px",
...
//           <div
//             style={{
//               width: `${calculateProgressPercentage(quantity)}%`,
//               background: "grey",
//               alignItems: "center",
//               color: "white",
//               fontWeight: "bold",
  ...
  />
      ...
      <div>
        ...
        >
          <div
            style={{
              width: `${(quantity / maxVolume) * 100 + 1}%`,
              background: "grey",
              // textAlign: "center",
              alignItems: "center",
              color: "white",
          ...
          {discountLevels.map((level, index) => (
            ...
            <div
              ...
              style={{
                position: "absolute",
                left: `${(level.volume / maxVolume + 1) * 100}%`,
                top: 0,
                height: "100%",
                width: "2px",
                background: "black",
